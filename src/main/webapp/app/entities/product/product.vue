<template>
  <div>
    ...
    <div class="alert alert-warning" v-if="!isFetching && products && products.length === 0">
      <span>Ningún Products encontrado</span>
    </div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <template #modal-title>
        <span id="ecommerceApp.product.delete.question" data-cy="productDeleteDialogHeading">Confirmar operación de borrado</span>
      </template>
      <div class="modal-body">
        <p id="jhi-delete-product-heading">¿Seguro que quiere eliminar Product {{ removeId }}?</p>
      </div>
