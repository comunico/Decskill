<template>
  <div>
    ...
    <div class="table-responsive" v-if="users">
      ...
      <b-modal ref="removeUser" id="removeUser" title="Confirmar operación de borrado" @ok="deleteUser()">
        ...
        <template #modal-footer>
          <div>
            ...
            <button type="button" class="btn btn-primary" id="confirm-delete-user" v-on:click="deleteUser()">Eliminar</button>
          </div>
        </template>
      </b-modal>
    </div>
