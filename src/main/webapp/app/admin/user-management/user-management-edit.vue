        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div v-if="v$.userAccount.login.$anyDirty && v$.userAccount.login.$invalid">
              <small class="form-text text-danger" v-if="!v$.userAccount.login.required">Este campo es obligatorio.</small>
          ...
          <div class="form-group">
            ...
            <div v-if="v$.userAccount.email.$anyDirty && v$.userAccount.email.$invalid">
              <small class="form-text text-danger" v-if="!v$.userAccount.email.required">Se requiere un correo electrónico.</small>
              <small class="form-text text-danger" v-if="!v$.userAccount.email.email">Su correo electrónico no es válido.</small>
