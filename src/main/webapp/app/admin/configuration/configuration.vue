<template>
  <div>
    <h2 id="configuration-page-heading" data-cy="configurationPageHeading">Configuración</h2>

    <div v-if="allConfiguration && configuration">
      <span>Filtro (por prefijo)</span> <input type="text" v-model="filtered" class="form-control" />
